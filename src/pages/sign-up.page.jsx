  ...
  return (
    <div className="grid min-h-screen gap-8 py-8 lg:grid-cols-[1fr_480px] lg:items-center">
      <section className="hidden rounded-lg border border-border bg-card p-10 lg:block">
        ...
        <h1 className="mt-12 max-w-lg">Create an account to apply with context</h1>
        <p className="mt-4 max-w-md">
          Submit focused answers for each role and help hiring teams understand your experience clearly.
        </p>
      </section>
